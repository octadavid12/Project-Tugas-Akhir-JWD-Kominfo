		...
		<table class="table table-striped table-bordered">
			...
			<tr>
				...
				<td class="text-center">
					<a href="index.php?p=kategori-ubah&id=<?php echo $data['id_kategori']; ?>" class="btn-ubah mg-btm-5">Ubah</a>
					<a href="index.php?p=kategori-hapus&id=<?php echo $data['id_kategori']; ?>" class="btn-hapus mg-btm-5 confirm">Hapus</a>
				</td>
			</tr>
			<?php
				}
