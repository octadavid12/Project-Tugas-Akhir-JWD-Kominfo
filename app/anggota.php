		...
		if(!empty($kata_kunci)) {
			...
			$sql = "SELECT * FROM anggota
					WHERE id_anggota LIKE '%{$kata_kunci}%'
						...
						OR status_aktif LIKE '%{$kata_kunci}%'
		...
		<table class="table table-striped table-bordered">
			...
			<tr>
				...
				<td class="text-center">
					<a href="./app/anggota-cetak-kartu-pdf.php?&id=<?php echo $data['id_anggota']; ?>" class="btn-cetak mg-btm-5" target="_blank">Cetak Kartu</a>
					<a href="index.php?p=anggota-ubah&id=<?php echo $data['id_anggota']; ?>" class="btn-ubah mg-btm-5">Ubah</a>
					<a href="index.php?p=anggota-hapus&id=<?php echo $data['id_anggota']; ?>" class="btn-hapus mg-btm-5 confirm">Hapus</a>
				</td>
			</tr>
			<?php
				}
